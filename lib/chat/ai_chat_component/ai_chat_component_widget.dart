                    ...
                    Align(
                      ...
                      child: FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          safeSetState(() {});
                          FFAppState().userInput = _model.textController.text;
                          safeSetState(() {});
                          // The "chatHistory" is the generated JSON -- we send the whole chat history to AI in order for it to understand context.
                          _model.chatGPTResponse =
                              await GroqGroup.sendFullPromptCall.call(
                            apiKey: FFDevEnvironmentValues().apigroq,
                            prompt:
                                '${FFAppState().initialPrompt}${FFAppState().personality}${FFAppState().userInput}',
                          );
                          ...
                          if ((_model.chatGPTResponse?.succeeded ?? true)) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Algo falhou, recarregue a página e tente novamente.',
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
